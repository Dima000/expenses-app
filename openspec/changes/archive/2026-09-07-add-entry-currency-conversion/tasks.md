...
- [x] 8.2 Manually verify the four states in the app: RON entry unchanged, a EUR entry converting and captioned, edit showing the caption read-only with no picker, and `/demo` making no rate request (check the network panel).
